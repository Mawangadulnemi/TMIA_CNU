document.addEventListener('DOMContentLoaded', function () {
  ...
  menuItems.forEach((item) => {
    item.addEventListener('click', function () {
      ...
      document.querySelector('.header__menu__item.active').classList.remove(
          'active');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const stepDescription = document.querySelector(
      '.introduce__step-description');
  ...
  tabs.forEach((tab) => {
    tab.addEventListener('click', function () {
      ...
      // Update active tab
      document.querySelector('.introduce__tab--active').classList.remove(
          'introduce__tab--active');
    ...
    if (photoFile) {
      ...
      reader.onload = function (e) {
        ...
        newProfile.innerHTML = `
                ...
                `;
        profilesContainer.insertBefore(newProfile,
            addProfileButton.parentElement);
      };
